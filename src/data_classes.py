...
class TelegaMessage(BaseModel):
    ...
    is_in_family:   Optional[bool] = Field(description='atribute that defines whether this message belongs to context topic (family)', default=False)
...
class TelegaMessageByFamily(TelegaMessage):
    is_in_family:   Optional[bool] = Field(description='atribute that defines whether this message belongs to context topic (family)', default=None)
